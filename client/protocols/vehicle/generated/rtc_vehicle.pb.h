...
#ifndef PB_VTSRTC_VEHICLE_V1_RTC_VEHICLE_PB_H_INCLUDED
#define PB_VTSRTC_VEHICLE_V1_RTC_VEHICLE_PB_H_INCLUDED
#include <pb.h>
...
/* Enum definitions */
typedef enum _vtsrtc_vehicle_v1_VehicleMessageType {
    vtsrtc_vehicle_v1_VehicleMessageType_VEHICLE_MESSAGE_TYPE_UNKNOWN = 0,
...
typedef enum _vtsrtc_vehicle_v1_DriveDirection {
    vtsrtc_vehicle_v1_DriveDirection_DRIVE_DIRECTION_STOP = 0,
    vtsrtc_vehicle_v1_DriveDirection_DRIVE_DIRECTION_FORWARD = 1,
    vtsrtc_vehicle_v1_DriveDirection_DRIVE_DIRECTION_REVERSE = 2
} vtsrtc_vehicle_v1_DriveDirection;

typedef enum _vtsrtc_vehicle_v1_SteeringDirection {
    vtsrtc_vehicle_v1_SteeringDirection_STEERING_DIRECTION_CENTER = 0,
    vtsrtc_vehicle_v1_SteeringDirection_STEERING_DIRECTION_LEFT = 1,
    vtsrtc_vehicle_v1_SteeringDirection_STEERING_DIRECTION_RIGHT = 2
} vtsrtc_vehicle_v1_SteeringDirection;

typedef enum _vtsrtc_vehicle_v1_VehicleGear {
    vtsrtc_vehicle_v1_VehicleGear_VEHICLE_GEAR_NEUTRAL = 0,
    vtsrtc_vehicle_v1_VehicleGear_VEHICLE_GEAR_FORWARD = 1,
    vtsrtc_vehicle_v1_VehicleGear_VEHICLE_GEAR_REVERSE = 2
} vtsrtc_vehicle_v1_VehicleGear;

typedef enum _vtsrtc_vehicle_v1_VehicleErrorCode {
    vtsrtc_vehicle_v1_VehicleErrorCode_VEHICLE_ERROR_CODE_NONE = 0,
    vtsrtc_vehicle_v1_VehicleErrorCode_VEHICLE_ERROR_CODE_INVALID_ARGUMENT = 1,
    vtsrtc_vehicle_v1_VehicleErrorCode_VEHICLE_ERROR_CODE_INVALID_STATE = 2,
...
/* 驾驶过程中通过 vehicle.control.v1 以 50 Hz 发送。若本地看门狗周期内没有收到有效帧，
 车辆控制器必须停车。 */
typedef struct _vtsrtc_vehicle_v1_DriveCommand {
    bool has_drive_direction;
    vtsrtc_vehicle_v1_DriveDirection drive_direction;
    bool has_steering_direction;
    vtsrtc_vehicle_v1_SteeringDirection steering_direction;
    /* 归一化输入范围为 [0.0, 1.0]。 */
    bool has_throttle;
    float throttle;
    bool has_brake;
    float brake;
} vtsrtc_vehicle_v1_DriveCommand;

/* 通过 vehicle.event.v1 发送。档位切换必须有序传输并可靠回执。 */
typedef struct _vtsrtc_vehicle_v1_SetGear {
    bool has_request_id;
    uint64_t request_id;
    bool has_gear;
...
typedef struct _vtsrtc_vehicle_v1_EventAck {
    ...
    bool accepted;
    bool has_error_code;
    vtsrtc_vehicle_v1_VehicleErrorCode error_code;
    bool has_active_gear;
    vtsrtc_vehicle_v1_VehicleGear active_gear;
} vtsrtc_vehicle_v1_EventAck;

/* 通过 vehicle.state.v1 以 20 Hz 发送，并在档位事务完成后立即发送。 */
typedef struct _vtsrtc_vehicle_v1_VehicleState {
    bool has_active_gear;
    vtsrtc_vehicle_v1_VehicleGear active_gear;
...
} vtsrtc_vehicle_v1_VehicleState;

typedef struct _vtsrtc_vehicle_v1_VehicleControlEnvelope {
    ...
    union {
        vtsrtc_vehicle_v1_DriveCommand drive_command;
...
#define _vtsrtc_vehicle_v1_DriveDirection_ARRAYSIZE ((vtsrtc_vehicle_v1_DriveDirection)(vtsrtc_vehicle_v1_DriveDirection_DRIVE_DIRECTION_REVERSE+1))

#define _vtsrtc_vehicle_v1_SteeringDirection_MIN vtsrtc_vehicle_v1_SteeringDirection_STEERING_DIRECTION_CENTER
#define _vtsrtc_vehicle_v1_SteeringDirection_MAX vtsrtc_vehicle_v1_SteeringDirection_STEERING_DIRECTION_RIGHT
#define _vtsrtc_vehicle_v1_SteeringDirection_ARRAYSIZE ((vtsrtc_vehicle_v1_SteeringDirection)(vtsrtc_vehicle_v1_SteeringDirection_STEERING_DIRECTION_RIGHT+1))

#define _vtsrtc_vehicle_v1_VehicleGear_MIN vtsrtc_vehicle_v1_VehicleGear_VEHICLE_GEAR_NEUTRAL
#define _vtsrtc_vehicle_v1_VehicleGear_MAX vtsrtc_vehicle_v1_VehicleGear_VEHICLE_GEAR_REVERSE
#define _vtsrtc_vehicle_v1_VehicleGear_ARRAYSIZE ((vtsrtc_vehicle_v1_VehicleGear)(vtsrtc_vehicle_v1_VehicleGear_VEHICLE_GEAR_REVERSE+1))

#define _vtsrtc_vehicle_v1_VehicleErrorCode_MIN vtsrtc_vehicle_v1_VehicleErrorCode_VEHICLE_ERROR_CODE_NONE
...
#define vtsrtc_vehicle_v1_VehicleState_active_gear_ENUMTYPE vtsrtc_vehicle_v1_VehicleGear
...
#define vtsrtc_vehicle_v1_DriveCommand_drive_direction_tag 1
#define vtsrtc_vehicle_v1_DriveCommand_steering_direction_tag 2
#define vtsrtc_vehicle_v1_DriveCommand_throttle_tag 3
...
#define vtsrtc_vehicle_v1_EventAck_active_gear_tag 4
#define vtsrtc_vehicle_v1_VehicleState_active_gear_tag 1
#define vtsrtc_vehicle_v1_VehicleState_last_received_drive_seq_tag 2
#define vtsrtc_vehicle_v1_VehicleState_watchdog_stopped_tag 3
#define vtsrtc_vehicle_v1_VehicleControlEnvelope_magic_tag 1
#define vtsrtc_vehicle_v1_VehicleControlEnvelope_protocol_major_tag 2
#define vtsrtc_vehicle_v1_VehicleControlEnvelope_protocol_minor_tag 3
#define vtsrtc_vehicle_v1_VehicleControlEnvelope_type_tag 4
#define vtsrtc_vehicle_v1_VehicleControlEnvelope_seq_tag 5
#define vtsrtc_vehicle_v1_VehicleControlEnvelope_drive_command_tag 10
...
#define vtsrtc_vehicle_v1_DriveCommand_CALLBACK NULL
#define vtsrtc_vehicle_v1_DriveCommand_DEFAULT NULL

#define vtsrtc_vehicle_v1_SetGear_FIELDLIST(X, a) \
...
#define vtsrtc_vehicle_v1_EventAck_CALLBACK NULL
#define vtsrtc_vehicle_v1_EventAck_DEFAULT NULL

#define vtsrtc_vehicle_v1_VehicleState_FIELDLIST(X, a) \
...
#define vtsrtc_vehicle_v1_VehicleState_CALLBACK NULL
#define vtsrtc_vehicle_v1_VehicleState_DEFAULT NULL
