...
includes("xmake/targets/camera.lua")
includes("xmake/targets/runtime.lua")
includes("xmake/targets/dual_camera.lua")
includes("xmake/targets/client_tests.lua")
includes("xmake/targets/rtc_edge.lua")
