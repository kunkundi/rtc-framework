...
class GStreamerH264EncoderImpl : public VideoEncoder {
 public:
  explicit GStreamerH264EncoderImpl(const cricket::VideoCodec& codec,
                                    const vts_rtc::RtcConfig& rtc_config);
  ~GStreamerH264EncoderImpl() override;
 ...
 private:
  ...
  static int MapProfileToGstLaunchProfileValue(H264::Profile profile);
 ...
 private:
  ...
  std::string encoder_name_ = "h264_gstreamer_nvv4l2";
